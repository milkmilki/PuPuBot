...
def apply_app_config_env(
    *,
    ...
    mapping = {
        ...
        "semantic_index.enabled": "PUPU_SEMANTIC_INDEX_ENABLED",
        "semantic_index.retrieve_top_k": "PUPU_SEMANTIC_INDEX_RETRIEVE_TOP_K",
        "semantic_index.embed_api_key": "PUPU_SEMANTIC_INDEX_EMBED_API_KEY",
        "semantic_index.embed_base_url": "PUPU_SEMANTIC_INDEX_EMBED_BASE_URL",
        "semantic_index.embed_model": "PUPU_SEMANTIC_INDEX_EMBED_MODEL",
        "semantic_index.timeout": "PUPU_SEMANTIC_INDEX_TIMEOUT",
